...
namespace Elektrogrosshandel.GUI.GUI_Menus
{
    ...
    internal class GUI_Impressum
    {
        ...
        private static Layout Impressum()
        {
            ...
            mainMenu["Right"].Update(PanelImpressum().Expand());
        ...
        private static Panel PanelImpressum()
        {
            List<Markup> infoLine = new List<Markup>(0);
            infoLine.Add(new Markup("[#c0c0c0]Graef Elektrogroßhandel GmbH[/]"));
            infoLine.Add(new Markup("[#c0c0c0]Gott-Lieb-Graef Straße 1[/]"));
            infoLine.Add(new Markup("[#c0c0c0]12345 Graefhausen[/]"));
            infoLine.Add(new Markup("[#c0c0c0]Telefon: +49 123 4567890[/]"));
            infoLine.Add(new Markup("[#c0c0c0]E-Mail: Kontakt@Graef.de[/]"));
            infoLine.Add(new Markup("[#c0c0c0]Geschäftsführer: Giacomo Graef[/]"));
            infoLine.Add(new Markup("[#c0c0c0]Handelsregister: HRB 123456[/]"));

            //Create Panel for Display area
            Panel panelDisplay = new Panel(new Rows(infoLine));
            panelDisplay.Height = 16;
        ...
        public static Layout ShowImpressum()
        {
            Layout ImpressumLayout = Impressum();
