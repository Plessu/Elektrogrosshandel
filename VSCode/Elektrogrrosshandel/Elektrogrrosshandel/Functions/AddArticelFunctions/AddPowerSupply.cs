...
{
    internal class AddPowerSupply
    {
        private static List<string> addItemsBase = new List<string>
        {
                "Bitte geben Sie den Namen des Netzteils ein",
        ...
        private static List<string> addItemsPSU = new List<string>
        {
                "Bitte geben Sie die Leistung in Watt ein (z.B. 650)",
        };

        private static List<string> GetAddPowerSupplyItems()
        {
            List<string> combinedList = new List<string>(addItemsBase);
            combinedList.AddRange(addItemsPSU);
            return combinedList;
        }

        public static void AddPowerSupplyMenu()
        {
            List<string> items = GetAddPowerSupplyItems();
            ...
            do
            {
                ...
                if (int.TryParse(s, out wattage)) break;
                AnsiConsole.MarkupLine("[red]Ungültige Eingabe. Bitte geben Sie die Leistung in Watt ein (nur Zahlen).[/]");
            } while (true);
            ...
            AnsiConsole.MarkupLine("[green]Das Netzteil wurde erfolgreich hinzugefügt![/]");
